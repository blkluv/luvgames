      ...
      <div className="mt-8 flex flex-col justify-between gap-6">
        <div className="xl flex flex-col gap-2">
          <div className="flex flex-row items-center gap-3">
            ...
            <h1 className="text-xl font-bold xl:text-2xl">Quests are jobs</h1>
          </div>
          <p className="text-gray-300 dark:text-gray-900 xl:text-lg">
            Complete quests to earn $LUV that can be barted or redeemed with our worldwide partners
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <div className="flex flex-row items-center gap-3">
            ...
            <h1 className="text-xl font-bold xl:text-2xl">Social media shine</h1>
          </div>
          <p className="text-gray-300 dark:text-gray-900 xl:text-lg">
            Do good and we will give you the spotlight you deserve on our socials
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <div className="flex flex-row items-center gap-3">
            ...
            <h1 className="text-xl font-bold xl:text-2xl">Purposecast</h1>
          </div>
          <p className="text-gray-300 dark:text-gray-900 xl:text-lg">
            Join our live Twitter spaces or listen to our upcoming Purposecast
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <div className="flex flex-row items-center gap-3">
            ...
            <h1 className="text-xl font-bold xl:text-2xl">Level up</h1>
          </div>
          <p className="text-gray-300 dark:text-gray-900 xl:text-lg">
            Level up and receive a personalized LUV NFT degree that verifies your heart
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <div className="flex flex-row items-center gap-3">
            ...
            <h1 className="text-xl font-bold xl:text-2xl">Funding</h1>
          </div>
          <p className="text-gray-300 dark:text-gray-900 xl:text-lg">
            Help us scale our gaming for good solution and we will fund your idea
          </p>
        </div>
      </div>
    </>
